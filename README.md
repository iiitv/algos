...
| Algorithm | C | CPP | Java | Python | Golang | JavaScript | C# | Ruby
|:--------------|:----------------:|:----------------:|:----------------:|:-----------------:|:-----------------:|:-----------------:| :-----------------:| :---------------: |
...
| [Breadth First Search](https://en.wikipedia.org/wiki/Breadth-first_search) | | | [:white_check_mark:](breadth_first_search/BreadthFirstSearch.java) |[:white_check_mark:](breadth_first_search/breadth_first_search.py) | | | | [:white_check_mark:](breadth_first_search/breadth_first_search.rb) |
