...
| [Doubly Ended Queue](https://www.includehelp.com/data-structure-tutorial/dequeue-queue-in-data-structure-using-c-and-cpp.aspx) | [:white_check_mark:](double_ended_queue/doubleEndedQueue.c) | |  |  | | | |
| [Disjoint Union Set](https://github.com/iiitv/algos) | [:white_check_mark:](Disjoint_union_set/Disjoint_union_set.c) | |  |  | | | |
...
| [Insertion Sort](https://en.wikipedia.org/wiki/Insertion_sort) | [:white_check_mark:](insertion_sort/insertion_sort.c) | 
[:white_check_mark:](insertion_sort/insertion_sort.cpp)| [:white_check_mark:](insertion_sort/InsertionSort.java)| [:white_check_mark:](insertion_sort/insertion_sort.py) | [:white_check_mark:](insertion_sort/insertion_sort.go) | [:white_check_mark:](insertion_sort/insertionSort.js) | [:white_check_mark:](insertion_sort/InsertionSort.cs) |
...
| [Nth Fibonacci Number](https://en.wikipedia.org/wiki/Fibonacci_number) |[:white_check_mark:](fibonacci_number/FibonacciNumber.c)| | [:white_check_mark:](fibonacci_number/FibonacciNumber.java) | | | | |
...
| [Soundex Algorithm](https://en.wikipedia.org/wiki/Soundex) | | | [:white_check_mark:](Soundex Algorithm/Soundex.java) |  |  |  |  |
...
| [Segment Tree](https://github.com/iiitv/algos/issues/url) | [:white_check_mark:](segment_tree/segment_tree.c)|  | | | | | | |
...
| [Double Linked List](https://github.com/iiitv/algos) | [:white_check_mark:](doubleLinkedList/doubleLinkedList.c) | |  |  |  | | |
...
| [Queue](https://en.wikipedia.org/wiki/Queue_(abstract_data_type)) | | | [:white_check_mark:](queue/Queue.java)| [:white_check_mark:](queue/queue.py) | | | |
